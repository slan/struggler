# Baselines — rules version 1 (archived)

> The ladder of the engine before the August 2026 fixes. On the current
> engine every version here loses most games to the held-scoring-card
> rule; the numbers below are what they were on that game. Read with
> [docs/archive/JOSHUA-r1.md](../../docs/archive/JOSHUA-r1.md).
