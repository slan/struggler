...
baselines/
  ...
  r2/              rules version 2, the current ladder: v1, v2, ...
...
from a clean run (`python -m wopr.ab`). The process, and the decision
points along it, are in [docs/WOPR.md](../docs/WOPR.md); the notebook
is [docs/JOSHUA.md](../docs/JOSHUA.md).
