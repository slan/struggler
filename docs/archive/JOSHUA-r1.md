> **Archived.** This is the lab notebook of rules version 1 — the engine
> before the August 2026 fixes, in which a scoring card could be held past
> the end of the turn. Every number in it was measured on that game; its
> baselines are under `baselines/r1/`. The live notebook is
> [../JOSHUA.md](../JOSHUA.md), which opens with what carried over.
